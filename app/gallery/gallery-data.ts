export const gallerySchools = [
  { name: '东莞市商业学校（东城校区）', club: '听雨文学社', slug: 'tingyu' },
  { name: '东莞市第七高级中学', club: '秋枫文学社', slug: 'no7-senior' },
  ...
  { name: '东莞市第六高级中学', club: '翰香文学社', slug: 'no6-senior' },
  { name: '东莞市常平中学', club: '青鹤湾文学社', slug: 'changping' },
  { name: '东莞市粤华学校', club: '流月文学社', slug: 'yuehua' },
  { name: '东莞市济川中学', club: '沐博文学社', slug: 'jichuan' },
